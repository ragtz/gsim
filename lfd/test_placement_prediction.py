...
test_demo_id = 5  #demonstration id to predict placement position, any number in range(num_demos,10)
train_data = [(u,e) for u in range(25) for e in range(5)]  #training data made up of (user_id, exp_id) tuples this example trains the nlp system on first 25 users for all experiments
